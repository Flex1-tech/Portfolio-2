...
export default function ContactSection() {
  ...
  const contactBio = profile.contact_bio || "I'm open to collaborations, internships, and research opportunities in AI and software engineering.";
  const contactEmail = profile.contact_email || "sethakplogan@gmail.com";
  const contactLinkedin = profile.contact_linkedin || "linkedin.com/in/seth-akplogan";
  const contactGithub = profile.contact_github || "github.com/Flex1-tech";
  const contactFooterTagline = profile.contact_footer_tagline || "Built with discipline & code.";
    ...
    >
      ...
      <div ref={contentRef}>
        ...
        <div className="flex flex-col gap-3">
          ...
          <a
            href={formatLink(contactLinkedin)}
            target="_blank"
